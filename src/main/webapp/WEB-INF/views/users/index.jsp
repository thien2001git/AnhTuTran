...
<%--	</section>--%>
	<!-- end client section -->
	<!-- start goongmap -->
	<script src="<c:url value="https://maps.goong.io/sdk/js/goong-js/v2.0.0/goong-js.js"/>"></script>
	<script>
		function initMap() {
			var map = new goongjs.Map({
				container : 'map',
				style : 'https://tiles.goong.io/assets/goong_map_web.json',
				center : [ 106.6882635, 10.7889713 ],
				zoom : 12,
				accessToken : 'rORsubrLDGeE8HKjb4CwunWfozbKamBXkXIW5FGK'
			});
		}
